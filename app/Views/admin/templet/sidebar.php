<section id="sidebar">
  <div class="profile-tab-nav border-right">
    <ul class="side-menu top menu">
      ...
      <li class="item">
        <a class="sub-btn" id="BookingRequest-tab" data-toggle="pill" role="tab" aria-controls="BookingRequests"
          aria-selected="false">
      ...
      <li class="item">
        <a class="sub-btn" id="History" data-toggle="pill" role="tab" aria-controls="History" aria-selected="false">
