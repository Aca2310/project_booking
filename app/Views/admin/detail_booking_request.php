	...
	<section id="sidebar">
		<div class="profile-tab-nav border-right">
			<ul class="side-menu top">
				<li >
					<a class="nav-link" id="dashboard-tab" data-toggle="pill" href="dashboard_admin" role="tab"
						aria-controls="dashboard" aria-selected="false" style="margin-top: 5%; ">
						<i class="fa-solid fa-chart-column" style="color: #ffffff;"></i>
						<span class="text">Dashboard</span>
					</a>
				</li>
				<li class="active">
					<a class="nav-link" id="BookingRequest-tab" data-toggle="pill" href="BookingRequest" role="tab"
                ...
                <li>
					<a class="nav-link" id="Driver-tab" data-toggle="pill" href="Driver" role="tab"
                ...
                <li >
					<a class="nav-link" id="ruangan-tab" data-toggle="pill" href="ruangan" role="tab"
                ...
                <li>
					<a class="nav-link" id="History" data-toggle="pill" href="History" role="tab"
            ...
            <div class="card-body">
                <div class="form-group row" >
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="pic" name="pic" style="width: 80%; border-radius: 10px;" value="aaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="Section" style="color: #281362; font-weight: 600;">Section</label>
                        <input type="text" class="form-control" id="section" name="section" style="width: 80%; border-radius: 10px;" value="aaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="Agenda" style="color: #281362; font-weight: 600;">Agenda</label>
                        <input type="text" class="form-control" id="agenda" name="agenda" style="width: 80%; border-radius: 10px;" value="aaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="Tanggal" style="color: #281362; font-weight: 600;">Tanggal</label>
                        <input type="text" class="form-control" id="tanggal" name="tanggal" style="width: 80%; border-radius: 10px;" value="aaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="JamMulai" style="color: #281362; font-weight: 600;">Jam Mulai</label>
                        <input type="text" class="form-control" id="JamMulai" name="JamMulai" style="width: 80%; border-radius: 10px;" value="aaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="JamSelesai" style="color: #281362; font-weight: 600;">Jam Selesai</label>
                        <input type="text" class="form-control" id="jamSelesai" name="jamSelesai" style="width: 80%; border-radius: 10px;" value="aaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="Keterangan" style="color: #281362; font-weight: 600;">Keterangan</label>
                        <input type="text" class="form-control" id="keterangan" name="keterangan" style="width: 80%; border-radius: 10px; height: 100px;" value="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa">
                    </div>
                    <div class="col-sm-6 mb-3">
                ...
                <div class="form-group row justify-content-between text-right">
                    ...
                    <div class="col-sm-6">
                        <button class="btn btn-danger" style="color: #ffffff;width: 100px; margin-right: 2%; border-radius: 20px;">Tolak</button>
                        <button class="btn btn-success" style="color: #ffffff;width: 100px; margin-right: 20%; border-radius: 20px;">Setujui</button>
                    </div>
